...
(async () => {
  try {   
        ...
        await db('schools_school').insert({
            "id": 2743619,
            "external_id": "",
            "name": "'X, Roses уран нугаралтын төв",
            "address": "",
            "postal_code": "",
            "email": null,
            ...
            "country_id": 175,
            "country": "Mongolia",
            "location_id": null, "giga_id": uuidv4(),
            "admin_2_name": "",
            "admin_3_name": "",
            "admin_4_name": "",
            "admin_1_name": ""
            ...
            "country": "Namibia",
            "location_id": null, "giga_id": uuidv4(),
            "admin_2_name": "Gobabis North",
            "admin_3_name": "B van der Walt",
            "admin_4_name": "",
            "admin_1_name": "Omaheke"
            })
            await db('schools_school').insert({
            "id": 904410,
            "external_id": "",
            ...
            "country": "Namibia",
            "location_id": null, "giga_id": uuidv4(),
            "admin_2_name": "Walvis Bay",
            "admin_3_name": "Walvis Primary",
            "admin_4_name": "",
            "admin_1_name": "Erongo"
            })
            await db('schools_school').insert({
            ...
            "country": "Namibia",
            "location_id": null, "giga_id": uuidv4(),
            "admin_2_name": "Omaruru",
            "admin_3_name": "Okombahe",
            "admin_4_name": "",
            "admin_1_name": "Erongo"
            })
            await db('schools_school').insert({
            "id": 2401168,
            "external_id": "4000",
            "name": " Малокомплектная основная школа имени М.Мәметовой КММ",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            "country": "Kazakhstan",
            "location_id": null, "giga_id": uuidv4(),
            "admin_2_name": "Тюлькубасский район",
            "admin_3_name": "с.Сарытур",
            "admin_4_name": "",
            "admin_1_name": "Туркестанская область"
            })
            await db('schools_school').insert({
            "id": 2854217,
            "external_id": "",
            ...
            await db('schools_school').insert({
            "id": 2015941,
            "external_id": "29pbh0042w",
            "name": "ABRAHAM LINCOLN TLAXCALA",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2001128,
            "external_id": "15pjn6505s",
            "name": "COLEGIO CULTURAL TERRANOVA",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2034753,
            "external_id": "09ppr1925z",
            "name": "COLEGIO LATINOAMERICANO",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2110653,
            "external_id": "19pct0028q",
            "name": "ACADEMIA DE SISTEMAS EN CIENCIAS COMPUTACIONALES A.C.",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2145657,
            "external_id": "19pjn1093w",
            "name": "ACADEMIA INFANTIL Y CULTURAL INDEPENDIENTE S.C.",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2110548,
            "external_id": "19pbh0210v",
            "name": "ACCION EDUCATIVA E INVESTIGACION S.C. COLEGIO INTERAMERICANO DEL NORTE",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2110678,
            "external_id": "19pet0013m",
            "name": "AVANCE INSTITUTO EN COMPUTACION A.C.",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2108018,
            "external_id": "15ect0015k",
            "name": "C.B.T.I. NUM. 25 OCTAVIO P",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2108185,
            "external_id": "15eet0002e",
            "name": "C.E.T. NUM. 8 UNIDAD DE ESTUDIOS TECNOLOGICOS CALMEC",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2107397,
            "external_id": "15dar0001w",
            "name": "CEDART FRIDA KAL",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2110469,
            "external_id": "19pbh0076f",
            "name": "CEDIEYES UNIVERSIDAD INTERNACIONAL S.C.",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2020402,
            "external_id": "32etv0017n",
            "name": "CENTENARIO DE LA CONSTITUCIÓN DE 1917",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2148822,
            "external_id": "22ejn0014u",
            "name": "CENTRO ASISTENCIAL DE DESARROLLO INFANTIL AURORA",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2086050,
            "external_id": "26kca0005f",
            "name": "CENTRO COMUNITARIO ITINERANTE CIRCO ESPECTACULAR ANDERSON",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2110451,
            "external_id": "19pbh0043o",
            "name": "CENTRO CULTURAL LUMEN A.C.",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2005048,
            "external_id": "19pjn1002o",
            "name": "CENTRO CULTURAL Y EDUCATIVO DE MONTERREY A.C.",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2115780,
            "external_id": "01ejn0005z",
            "name": "CENTRO DE DESARROLLO INFANTIL REFORMA",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2004901,
            "external_id": "19pbh0203l",
            "name": "CENTRO DE DESARROLLO TECNOLOGICO MARIO J. MONTEMAYOR GARCIA DE LA CIUDAD DE LOS NINOS DE MTY. A.B.P",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2005045,
            "external_id": "19pjn0121v",
            "name": "CENTRO DE EDUCACION Y CULTURA DEL VALLE S.C.",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2110545,
            "external_id": "19pbh0202m",
            "name": "CENTRO DE ENSEÑANZA ACERO A.C.",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2110041,
            "external_id": "17etc0003d",
            "name": "CENTRO DE ESTUDIOS CIENTIFICOS Y TECNOLOGICOS PLANTEL EMILIANO ZAPATA",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2110039,
            "external_id": "17etc0001f",
            "name": "CENTRO DE ESTUDIOS CIENTIFICOS Y TECNOLOGICOS UNIDAD TENEXTEPANGO",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2110040,
            "external_id": "17etc0002e",
            "name": "CENTRO DE ESTUDIOS CIENTIFICOS Y TECNOLOGICOS UNIDAD YECAPIXTLA",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2110487,
            "external_id": "19pbh0103m",
            "name": "CENTRO DE ESTUDIOS TECNICOS DE MONTERREY S.C.",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2110485,
            "external_id": "19pbh0097s",
            "name": "CENTRO EDUCATIVO DE FORMACION SUPERIOR A.C.",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2005017,
            "external_id": "19pjn0200h",
            "name": "CENTRO ESCOLAR GANTE A.C.",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2145640,
            "external_id": "19pjn1065z",
            "name": "CENTRO INFANTIL DE DESARROLLO BASICO S.C. UNIDAD PESQUERIA",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2145201,
            "external_id": "19pjn0465p",
            "name": "CENTRO INFANTIL DE DESARROLLO BASICO S.C.",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2110438,
            "external_id": "19pbh0030k",
            "name": "CENTRO INTERNACIONAL EN SISTEMAS COMPUTACIONALES S.C.",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2005016,
            "external_id": "19pbh0251v",
            "name": "CENTRO UNIVERSITARIO FRANCO MEXICANO DE MONTERREY A.C.",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2110643,
            "external_id": "19pbh3751k",
            "name": "CENTRO UNIVERSITARIO FRANCO MEXICANO DE MONTERREY BACHILLERATO",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2089324,
            "external_id": "28dpr2397p",
            "name": "CLUB DE LEONES INTERNACIONAL NO.8 PROFA. JULIA GUEVARA HERNANDEZ",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2069238,
            "external_id": "19dpr1328e",
            "name": "CLUB DE LEONES MONTERREY PONIENTE A.C. RICARDO MARTINEZ",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2069332,
            "external_id": "19dpr1511c",
            "name": "CLUB DE LEONES NUM. 1 SANTA CATARINA A.C.",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2154656,
            "external_id": "28djn0361x",
            "name": "CLUB ROTARIO VALLE HERMOSO 86",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
            ...
            await db('schools_school').insert({
            "id": 2005034,
            "external_id": "19pjn0142h",
            "name": "COLEGIO ANTONIO L. RODRIGUEZ A.C.",
            "address": "",
            "postal_code": "",
            "email": null,
            "education_level": "",
