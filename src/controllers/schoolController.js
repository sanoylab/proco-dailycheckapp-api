...
module.exports.getAll = async (req, res) => {
  try {
    ...
    school.admin_4_name, school.admin_1_name, school.giga_id FROM public.schools_school school INNER JOIN public.locations_country country ON school.country_id=country.id 
